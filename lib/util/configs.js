...
functions.merge_alias = function(input, done) {
    if (input.params.alias) {
        try {
            traverse(input.stacks).forEach(function (obj) {
                if (!_.isNil(obj.stack)) {
                    this.after(function () {
                        if (!_.isNil(obj.alias) && !_.isNil(obj.alias[input.params.alias]) && !_.isEmpty(obj.alias[input.params.alias])) {
                            _.merge(obj, obj.alias[input.params.alias]);
                            delete obj.alias;
                        }
                    });
                }
