        ...
        return [
            {
                ...
                params: {
                    ...
                    prune: {
                        describe: 'Prune all unused Lambda versions.  Defaults to \'false\'.',
                        required: false,
                        default: false
                    },
                    stage: {
            ...
            {
                command: 'lambda-prune',
                description: 'Delete one or all unused Lambda versions.',
                params: {
                    dir: {
                        describe: 'The directory this command will run in.  Defaults to the current directory.',
                        required: false,
                    ...
                    version: {
                        describe: 'Lambda function version or \'all\' to remove all unused versions.',
                        required: true
                    },
                    stage: {
                        describe: 'Create or update the stack(s) using the give stage.',
